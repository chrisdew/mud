...
function createCommand() {
  ...
  var command = or(
    thens(verb_drink, space, noun_drinkable),
    thens(verb_drink, chars('from'), noun_drinkable),
    thens(verb_drop, noun_item),
    verb_exit,
    thens(verb_go, direction),
    thens(verb_put, noun_item, prep, noun),
    thens(verb_hang, noun_item, chars('on', 'prep'), noun),
    thens(verb_throw, noun_item),
    'command'
  );
